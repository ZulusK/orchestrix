...
void Equalizer::setChunk(double *chunk, int * startYArr)
{
    ...
    animationLine3->setStartValue(QLine(xCoordinateArray[2] + 5 , *(startYArr + 2) , xCoordinateArray[3] , *(startYArr + 3)));
    animationLine3->setEndValue(QLine( xCoordinateArray[2] + 5 , 150 - yCoordinateArray[2]  ,xCoordinateArray[3] , 150 - yCoordinateArray[3]));
    animationLine3->start(QAbstractAnimation::DeleteWhenStopped);
    ...
    animationLine4->setStartValue(QLine(xCoordinateArray[3] + 5 , *(startYArr + 3) , xCoordinateArray[4] , *(startYArr + 4)));
    animationLine4->setEndValue(QLine( xCoordinateArray[3] + 5 , 150 - yCoordinateArray[3]  ,xCoordinateArray[4] , 150 - yCoordinateArray[4]));
    animationLine4->start(QAbstractAnimation::DeleteWhenStopped);
    ...
    animationLine5->setStartValue(QLine(xCoordinateArray[4] + 5 , *(startYArr + 4) , xCoordinateArray[5] , *(startYArr + 5)));
    animationLine5->setEndValue(QLine( xCoordinateArray[4] + 5 , 150 - yCoordinateArray[4]  ,xCoordinateArray[5] , 150 - yCoordinateArray[5]));
    animationLine5->start(QAbstractAnimation::DeleteWhenStopped);
    ...
    animationLine6->setStartValue(QLine(xCoordinateArray[5] + 5 , *(startYArr + 5) , xCoordinateArray[6] , *(startYArr + 6)));
    animationLine6->setEndValue(QLine( xCoordinateArray[5] + 5 , 150 - yCoordinateArray[5]  ,xCoordinateArray[6] , 150 - yCoordinateArray[6]));
    animationLine6->start(QAbstractAnimation::DeleteWhenStopped);
    ...
    animationLine7->setStartValue(QLine(xCoordinateArray[6] + 5 , *(startYArr + 6) , xCoordinateArray[7] , *(startYArr + 7)));
    animationLine7->setEndValue(QLine( xCoordinateArray[6] + 5 , 150 - yCoordinateArray[6]  ,xCoordinateArray[7] , 150 - yCoordinateArray[7]));
    animationLine7->start(QAbstractAnimation::DeleteWhenStopped);
    ...
    animationLine8->setStartValue(QLine(xCoordinateArray[7] + 5 , *(startYArr + 7) , xCoordinateArray[8] , *(startYArr + 8)));
    animationLine8->setEndValue(QLine( xCoordinateArray[7] + 5 , 150 - yCoordinateArray[7]  ,xCoordinateArray[8] , 150 - yCoordinateArray[8]));
    animationLine8->start(QAbstractAnimation::DeleteWhenStopped);
    ...
    animationLine9->setStartValue(QLine(xCoordinateArray[8] + 5 , *(startYArr + 8) , xCoordinateArray[9] , *(startYArr + 9)));
    animationLine9->setEndValue(QLine( xCoordinateArray[8] + 5 , 150 - yCoordinateArray[8]  ,xCoordinateArray[9] , 150 - yCoordinateArray[9]));
    animationLine9->start(QAbstractAnimation::DeleteWhenStopped);
    ...
    animationLine10->setStartValue(QLine(xCoordinateArray[9] + 5 , *(startYArr + 9) , xCoordinateArray[10] , *(startYArr + 10)));
    ...
    animationLine10->start(QAbstractAnimation::DeleteWhenStopped);
    ...
    animationLine11->setStartValue(QLine(xCoordinateArray[10] + 5 , *(startYArr + 10) , xCoordinateArray[11] , *(startYArr + 11)));
    ...
    animationLine11->start(QAbstractAnimation::DeleteWhenStopped);
    ...
    animationLine12->setStartValue(QLine(xCoordinateArray[11] + 5 , *(startYArr + 11) , xCoordinateArray[12] , *(startYArr + 12)));
    ...
    animationLine12->start(QAbstractAnimation::DeleteWhenStopped);
    ...
    animationLine13->setStartValue(QLine(xCoordinateArray[12] + 5 , *(startYArr + 12) , xCoordinateArray[13] , *(startYArr + 13)));
    ...
    animationLine13->start(QAbstractAnimation::DeleteWhenStopped);
    ...
    animationLine14->setStartValue(QLine(xCoordinateArray[13] + 5 , *(startYArr + 13) , xCoordinateArray[14] , *(startYArr + 14)));
    ...
    animationLine14->start(QAbstractAnimation::DeleteWhenStopped);
    ...
    animationLine15->setStartValue(QLine(xCoordinateArray[14] + 5 , *(startYArr + 14) , xCoordinateArray[15] , *(startYArr + 15)));
    ...
    animationLine15->start(QAbstractAnimation::DeleteWhenStopped);
    ...
    animationLine16->setStartValue(QLine(xCoordinateArray[15] + 5 , *(startYArr + 15) , xCoordinateArray[16] , *(startYArr + 16)));
    ...
    animationLine16->start(QAbstractAnimation::DeleteWhenStopped);
    ...
    animationLine17->setStartValue(QLine(xCoordinateArray[16] + 5 , *(startYArr + 16) , xCoordinateArray[17] , *(startYArr + 17)));
    ...
    animationLine17->start(QAbstractAnimation::DeleteWhenStopped);
    ...
    animationLine18->setStartValue(QLine(xCoordinateArray[17] + 5 , *(startYArr + 17) , xCoordinateArray[18] , *(startYArr + 18)));
    ...
    animationLine18->start(QAbstractAnimation::DeleteWhenStopped);
    ...
    animationLine19->setStartValue(QLine(xCoordinateArray[18] + 5 , *(startYArr + 18) , xCoordinateArray[19] , *(startYArr + 19)));
    ...
    animationLine19->start(QAbstractAnimation::DeleteWhenStopped);
    ...
    animation7->start(QAbstractAnimation::DeleteWhenStopped);
    ...
    animation8->start(QAbstractAnimation::DeleteWhenStopped);
    ...
    animation9->start(QAbstractAnimation::DeleteWhenStopped);
    ...
    animation10->start(QAbstractAnimation::DeleteWhenStopped);
    ...
    animation11->start(QAbstractAnimation::DeleteWhenStopped);
    ...
    animation12->start(QAbstractAnimation::DeleteWhenStopped);
    ...
    animation13->start(QAbstractAnimation::DeleteWhenStopped);
    connect(animation3, &QPropertyAnimation::valueChanged , [=](){update();});
    ...
    animation14->start(QAbstractAnimation::DeleteWhenStopped);
    ...
    animation15->start(QAbstractAnimation::DeleteWhenStopped);
    ...
    animation16->start(QAbstractAnimation::DeleteWhenStopped);
    ...
    animation17->start(QAbstractAnimation::DeleteWhenStopped);
    ...
    animation18->start(QAbstractAnimation::DeleteWhenStopped);
    ...
    animation19->start(QAbstractAnimation::DeleteWhenStopped);
    ...
    animation20->start(QAbstractAnimation::DeleteWhenStopped);
